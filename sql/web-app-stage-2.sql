...
-- Принцип: существующие telegram-функции НЕ изменяются вообще.
...
-- Тонкие обёртки: авторизуют вызов по auth.uid() и переиспользуют
-- существующую логику server_register_for_event / server_unregister_from_event.
