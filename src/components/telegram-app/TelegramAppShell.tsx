...
import { TelegramActivitiesView } from './TelegramActivitiesView';
...
import { TelegramPyramidView } from './TelegramPyramidView';
...
export type Section = 'home' | 'schedule' | 'nutrition' | 'activities' | 'ascetics' | 'homework' | 'profile' | 'rating' | 'pyramid' | 'journal' | 'shop';
...
export const TelegramAppShell: React.FC = () => {
  ...
  if (activeSection === 'activities') {
    return <TelegramActivitiesView onBack={() => setActiveSection('home')} />;
  }

  if (activeSection === 'ascetics') {
    return <TelegramAsceticsView onBack={() => setActiveSection('home')} />;
  }

  if (activeSection === 'homework') {
    return <TelegramHomeworkView onBack={() => setActiveSection('home')} />;
  }
  ...
  if (activeSection === 'pyramid') {
    return <TelegramPyramidView onBack={() => setActiveSection('home')} />;
  }
