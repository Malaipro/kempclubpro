-- Исправляем функцию update_user_leaderboard для корректного подсчёта баллов
...
BEGIN
  ...
  -- Баллы из других активностей (добавляются к tactical_points)
  SELECT 
...
-- Пересчитываем баллы для всех пользователей
DO $$
DECLARE
  user_record RECORD;
BEGIN
